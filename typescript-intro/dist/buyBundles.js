...
const buyBundles = () => {
    ...
    rl.question("Welcome to our service, please enter your name: ", (userName) => {
        console.log(`\nWelcome ${userName}!!`);
        ...
        rl.question("What choice will you have today? ", (bundleChoice) => {
            switch (bundleChoice) {
                case "1":
...
//# sourceMappingURL=buyBundles.js.map